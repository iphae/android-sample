...
public class SettingsUtil {
    //Begin add by xu.wei.hz for GLModule XR *6709714  on 18-8-20
    public static final String QUALITY_1080P_60FPS_NAME = "QUALITY_1080P_60FPS";
    public static final String QUALITY_1080P_60FPS = "-6";
    //End add by xu.wei.hz for GLModule XR *6709714 on 18-8-20
    //Begin add by zhenhua.chen for defect:7076542 on 2018/11/08
    public static final int KEYCODE_FP_PRESS = -286;
    //End add by zhenhua.chen for defect:7076542 on 2018/11/08
    /**
    ...
    public static boolean isVideoQualitySupported(int videoQuality) {
        ...
        return !(!ApiHelper.isLOrHigher() && videoQuality == CamcorderProfile.QUALITY_2160P);
    }
    ...
    public interface CameraDeviceSelector {
         ...
         */
        boolean useCamera(CameraDeviceInfo.Characteristics info);
    }
    ...
    //Begin add by xu.wei.hz for XR 6709333  on 18-7-19
    static public com.android.ex.camera2.portability.Size sizeFromString(String sizeSetting) {
        String[] parts = sizeSetting.split("x");
        if (parts.length == 2) {
            return new com.android.ex.camera2.portability.Size(Integer.valueOf(parts[0]), Integer.valueOf(parts[1]));
        } else {
            return null;
        }
    }
...
//        }
//
//        String[] sizes = TextUtils.split(sizeQueue, com.android.ex.camera2.portability.Size.DELIMITER);
...
//        Log.i(TAG, "Cannot get default size for flag " + value  + "in queue " + sizeQueue);
    ...
    public static String sizeToSetting(com.android.ex.camera2.portability.Size size) {
        return ((Integer) size.width()).toString() + "x" + ((Integer) size.height()).toString();
    }
    //End add by xu.wei.hz for XR 6709333 on 18-7-19
}
