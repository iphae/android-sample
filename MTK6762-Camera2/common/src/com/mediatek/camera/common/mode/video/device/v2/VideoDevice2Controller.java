...
public class VideoDevice2Controller extends Device2Controller
    ...
    public void takePicture(@Nonnull JpegCallback callback) {
        ...
        try {
            ...
            if (builder == null) {
                LogHelper.e(TAG, "[takePicture] builder is null, return");
                return;
            }
    ...
    private void configureSession() {
        ...
        try {
            ...
            if (builder == null) {
                LogHelper.e(TAG, "[configureSession] builder is null, return");
                return;
            }
    ...
    private void configureQuickPreview(CaptureRequest.Builder builder) {
        ...
        if (mQuickPreviewKey != null && builder != null) {
    ...
    private CaptureRequest.Builder doCreateAndConfigRequest(boolean isRecording)
        ...
        if (mCamera2Proxy != null) {
            ...
            if (builder == null) {
                LogHelper.e(TAG, "[doCreateAndConfigRequest] builder is null, return null");
                mBuilder = builder;
                return builder;
            }
    ...
    private void setStopRecordingToCamera() {
        ...
        if (isRecordStateSupported() && states.contains(STREAMING_FEATURE_STATE_PREVIEW)) {
            if (mBuilder == null) {
                LogHelper.e(TAG, "[setStopRecordingToCamera] mBuilder is null, return");
                return;
            }
