        ...
        Preloader.ItemLoader<Integer, AsyncTask>, Preloader.ItemSource<Integer>
{
     ...
     */
    public com.android.camera.data.FilmstripItem getItemAt(int index);
     ...
     */
    public boolean addOrUpdate(com.android.camera.data.FilmstripItem item);
     ...
     * @param item  The new data.
     */
    public void updateItemAt(int index, com.android.camera.data.FilmstripItem item);
