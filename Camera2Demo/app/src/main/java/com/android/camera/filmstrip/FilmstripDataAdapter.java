 ...
 * {@link com.android.camera.data.FilmstripItem} and the
...
public interface FilmstripDataAdapter
{
     ...
     * {@link com.android.camera.data.FilmstripItem}. Usually
    ...
    public interface Listener
    {
         ...
         */
        public void onFilmstripItemInserted(int index, com.android.camera.data.FilmstripItem item);
         ...
         * @param item  The data.
         */
        public void onFilmstripItemRemoved(int index, com.android.camera.data.FilmstripItem item);
    }
    ...
    /**
     * Returns the {@link com.android.camera.data.FilmstripItem} specified by the ID.
     *
     * @param index The ID of the {@link com.android.camera.data.FilmstripItem}.
     * @return The specified {@link com.android.camera.data.FilmstripItem}. Null if not available.
     */
    public com.android.camera.data.FilmstripItem getFilmstripItemAt(int index);
     ...
     * {@link com.android.camera.data.FilmstripItem}.
     *
