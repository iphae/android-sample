...
public class MediaSaverImpl implements MediaSaver
{
    ...
    @Override
    public void addImage(Bitmap data, String title, long date, Location loc, int width, int height, int orientation, ExifInterface exif, OnMediaSavedListener l, String mimeType) {

    }

    @Override
    public void updateImage(Bitmap data, Uri outputUri, String title, long date, Location loc, int width, int height, int orientation, ExifInterface exif, OnMediaSavedListener l, String mimeType) {

    }

    @Override
    public void updateImage(Bitmap data, Uri outputUri, String title, long date, Location loc, int width, int height, int orientation, ExifInterface exif, OnMediaSavedListener l) {
    ...
    @Override
    public void addRawImage(byte[] data, String title, String pictureFormat) {
