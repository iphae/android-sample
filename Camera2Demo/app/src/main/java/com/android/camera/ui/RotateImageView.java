...
public class RotateImageView extends TwoStateImageView implements Rotatable {
    ...
    public void setOrientation(int degree, boolean animation) {
        ...
        //End added by shile.wu for PR 5489358 on 2017/10/26
        //End modified by shile.wu for PR 5496426 on 2017/10/31
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //Begin modified by shile.wu delete (width < w) || (height < h) for gd adjust task 5091845 on 2017/08/21
        ...
        //End modified by shile.wu delete (width < w) || (height < h) for gd adjust task 5091845 on 2017/08/21
    ...
    public void setBitmap(Bitmap bitmap) {
        ...
        if (mThumbs == null || !mEnableAnimation) {
            ...
            mThumbs[0] = mThumbs[1];
            mThumbs[1] = new BitmapDrawable(getContext().getResources(), mThumb);
            TransitionDrawable mThumbTransition = new TransitionDrawable(mThumbs);
    ...
    //Begin added by shile.wu for PR 5489358 on 2017/10/26
