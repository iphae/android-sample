...
public interface OrientationManager {
    enum DeviceNaturalOrientation {
        ...
        DeviceNaturalOrientation(int orientation) {
     ...
     */
    void addOnOrientationChangeListener(OnOrientationChangeListener listener);
    ...
    //Begin add by zhenhua.chen for defect:7351810 on 2019/2/20
    // Return the raw orientation
    int getRawOrientation();
    //End add by zhenhua.chen for defect:7351810 on 2019/2/20
}
